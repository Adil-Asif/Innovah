...
app.get('/createtables',(req,res)=>{
   ...
   let sql14='create table learning( trainerid varchar(200) , userid varchar(200) not null, foreign KEY(userid) references user_details (userid), title varchar(200), description varchar(200) not null, status varchar(200) not null, imageurl mediumtext not null,primary KEY (trainerid, title)    )';
