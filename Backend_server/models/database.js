...
app.get('/createtables',(req,res)=>{
   ...
   let sql14='create table learning( trainerid varchar(200) , userid varchar(200) not null, foreign KEY(userid) references user_details (userid), title varchar(200), description varchar(200) not null, completedstatus tinyint(1) not null,enrolledstatus tinyint(1) not null ,imageurl mediumtext not null,playlisturl text not null,primary KEY (trainerid, title)    )';
   
   let sql15='create table playlist( url varchar(200) , trainerid varchar(200) , status  varchar(200) not null, playlisttitle  varchar(200) not null, description  varchar(200) not null, userid  varchar(200),videotitle varchar(200) not null ,primary KEY (url, trainerid, userid), foreign KEY (trainerid,playlisttitle) references learning(trainerid,title), foreign KEY (userid) references  user_details(userid)  )';
