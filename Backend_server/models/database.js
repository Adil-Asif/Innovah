...
//        let sql1 = 'create table idea( ideaid varchar(200) PRIMARY KEY, title varchar(200) Not Null, description varchar(200) Not Null, image varchar(2000) Not Null, visibility varchar(200) Not Null, ideaindustry varchar(200) Not Null, userid varchar(200) Not Null,domain varchar(2000) Not Null ,foreign key (userid) references user_details(userid) )'; 
...
//        let sql6='create table posting_request( requestid varchar(200) PRIMARY KEY, requesttitle varchar(200) Not Null, request_description varchar(5000) Not Null,    image varchar(2000) Not Null, userid varchar(200) , foreign key (userid) references user_details(userid),isHired tinyint(1)  )';
...
//        let sql14='create table learning( trainerid varchar(200) , userid varchar(200) not null, foreign KEY(userid) references user_details (userid), title varchar(200), description varchar(200) not null, status varchar(200) not null,playlistid text Unique Not Null ,imageurl mediumtext not null,primary KEY (userid, title)    )';
//        let sql18='create table submission_table(submission_id varchar(200) Primary KEY,submitted_by varchar(200) Not Null, request_id varchar(200), proposal_content varchar(3000) Not Null,foreign key(request_id) references posting_request(requestid) )';   
//        let sql15='create table playlist( id varchar(200) , trainerid varchar(200) , status  varchar(200) not null, title  varchar(200) not null, description  varchar(200) not null, userid  varchar(200) ,videoiframe text Unique Not Null ,primary KEY (id, userid), foreign KEY (playlisttitle) references learning(title), foreign KEY (userid) references  user_details(userid)  )';
...
//    let sql3='create table idea_deliverables( delivery varchar(200), ideaid varchar(200) , Foreign KEY (ideaid) REFERENCES idea(ideaid), PRIMARY KEY(delivery,ideaid) )';
//    let sql4='create table idea_insights( ideaid varchar(200), Foreign KEY (ideaid) REFERENCES idea(ideaid), insightid varchar(200) PRIMARY KEY, likes int Not Null, ideaviews int Not Null, insighttype varchar(200) Not Null )';
//    let sql5='create table idea_comment( ideaid varchar(200), Foreign KEY (ideaid) REFERENCES idea(ideaid), ideacomment varchar(2000) Not Null, commentby varchar(200) Not Null,  Primary key(commentby) )';
//    let sql6='create table posting_request( requestid varchar(200) PRIMARY KEY, requesttitle varchar(200) Not Null, request_description varchar(5000) Not Null,    image varchar(2000) Not Null, userid varchar(200) , foreign key (userid) references user_details(userid),isHired tinyint(1)  )';
//    let sql7='create table request_insights( requestid varchar(200) Not null, Foreign KEY (requestid) REFERENCES posting_request(requestid), insightid varchar(200) PRIMARY KEY,  likes int Not Null, requestviews int not null, insighttype varchar(200) Not Null  )';
//    let sql8='create table request_comments( requestid varchar(200) Not null, ideaid varchar(200) not null,  requestcomment varchar(2000) Not Null, messageby varchar(200) Not Null, insightid varchar(200) Not Null, Foreign Key (insightid) REFERENCES idea_insights(insightid), Primary key(insightid,messageby), foreign key (requestid) references posting_request(requestid), foreign key(ideaid) references idea(ideaid) )';
//    let sql9='create table project_details( projectid varchar(200) Primary KEY, projecttitles varchar(200) Not Null, description varchar(200) Not Null, projectstatus varchar(200) Not Null, ideaid varchar(200) Not Null, foreign key (ideaid) references idea(ideaid)  )';
