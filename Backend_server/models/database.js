...
// //    let sql13='create table inventory( inventoryid varchar(200) not null, projectid varchar(200) not null, itemstatus varchar(200) not null, quantity int not null, inventoryvalue int not null, addedby varchar(200) not null, itemdescription varchar(200) not null, primary KEY(inventoryid), foreign KEY (projectid) references project_details(projectid) )';
// //    let sql14='create table learning( trainerid varchar(200) , userid varchar(200) not null, foreign KEY(userid) references user_details (userid), title varchar(200), description varchar(200) not null, status varchar(200) not null, primary KEY (trainerid, title)    )';
