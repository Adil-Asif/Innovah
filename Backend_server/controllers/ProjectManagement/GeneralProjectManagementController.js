     ...
     let sql = `SELECT MAX(CAST(projectid AS SIGNED)) FROM project_details;`
      model.query(sql, (err, result) => {
         try {
             ...
             sql = `insert into project_details(projectid,projecttitles,description,projectimage,ideaid) values ('${currentID}','${req.body.projectTitle}','${req.body.projectDescription}','${req.body.projectImage}',${req.body.Idea});`
