...
const WorkItems = () => {
  ...
  const fetchBoards = async () => {
    let response = await fetch(
      `https://innovah-backend.herokuapp.com/projectboards/getboard/${params.projectid}`
    );
  ...
  const fetchCounts = async()=>{
    let response = await fetch(
      `https://innovah-backend.herokuapp.com/projectboards/getboard/${params.projectid}/filter`
    );
  ...
  const onFinish = (values) => {
    fetch(
      `https://innovah-backend.herokuapp.com/projectboards/${params.projectid}/addnewtask`,
      {
        // Adding method type
        method: "POST",
  ...
  const sendingChangetoDB= async(taskid,updateStatus)=>{
    let response = await fetch(
      `https://innovah-backend.herokuapp.com/projectboards/updateboard`,
      {
        // Adding method type
        method: "POST",
