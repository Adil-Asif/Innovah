...
const InventoryManagement = () => {
  ...
  const fetchInventory = async () => {
    let response = await fetch(
      `https://innovah-backend.herokuapp.com/projectinventory/getinventory/${params.projectid}`
    );
    setFetchInventoryITems(await response.json());

    response = await fetch(
      `https://innovah-backend.herokuapp.com/projectinventory/getinventory/${params.projectid}/filter`
    );
  ...
  const sendingChangetoDB = async (inventoryid, updateStatus) => {
    let response = await fetch(
      `https://innovah-backend.herokuapp.com/projectinventory/updateitem`,
      {
        // Adding method type
        method: "POST",
  ...
  const onFinish = (values) => {
    ...
    if (
      ...
      fetch(
        `https://innovah-backend.herokuapp.com/projectinventory/${params.projectid}/addnewitem`,
        {
          // Adding method type
          method: "POST",
